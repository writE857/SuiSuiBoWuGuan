...
namespace EPOOutline
{
    ...
    public class Outliner : MonoBehaviour
    {
        ...
        {
            if (parametersToUse.Buffer is BasicCommandBufferWrapper basicWrapper && basicWrapper.UnderlyingBuffer == null)
                basicWrapper.SetCommandBuffer(new CommandBuffer() { name = isEditor ? "EPO Editor Preview" : "EPO" });
