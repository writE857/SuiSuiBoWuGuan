...
public class EditorButtonHelper : Editor
{
    public override void OnInspectorGUI()
    {
        ...
        var methods = mono.GetType()
            .GetMethods(
                ...
                Attribute.IsDefined(method, typeof(EditorButtonAttribute))
            ).ToArray();
 
        foreach (var method in methods)
        {
            var attr = CustomAttributeExtensions.GetCustomAttribute<EditorButtonAttribute>(method);
