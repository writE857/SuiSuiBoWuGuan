...
public class SFXVolumeSettingsEntry : SettingsEntryLogic
{
	public AudioMixer mixer;

	public string exposedParam = "SFXVolume";
	...
	protected override void _Apply()
	{
		if (mixer == null)
		{
			Debug.LogWarning("SFXVolumeSettingsEntry: Mixer not assigned.");
			return;
		}
		...
		Debug.Log($"SFX volume set to {num}% ({num2} dB)");
	}
}
