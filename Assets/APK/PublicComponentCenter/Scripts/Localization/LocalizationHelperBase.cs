...
namespace PublicComponentCenter
{
    ...
    public abstract class LocalizationHelperBase : ILocalizationHelper
    {
        ...
        public bool LoadDictionary(string dictionaryAssetName, object dictionaryObject, object userData)
        {
            ...
            return LoadDictionary(loadDictionaryInfo.DictionaryName, dictionaryAssetName, dictionaryObject,
        ...
        /// <param name="userData">用户自定义数据。</param>
        /// <returns>是否加载成功。</returns>
        protected abstract bool LoadDictionary(string dictionaryName, string dictionaryAssetName,
