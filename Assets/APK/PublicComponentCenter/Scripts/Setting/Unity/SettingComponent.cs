...
namespace PublicComponentCenter
{
    ...
    public sealed class SettingComponent : ComponentBase
    {
        ...
        public override void Awake()
        {
            ...
            //TODO Frame 动态加载种类
            SettingHelperBase settingHelper = new GameObject().AddComponent<PlayerPrefsSettingHelper>();
        ...
        private void Start()
        {
            ...
            {
                Debug.LogError("Load settings failure.");
            }
        }
