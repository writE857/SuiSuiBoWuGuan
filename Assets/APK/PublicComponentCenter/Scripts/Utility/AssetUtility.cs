...
namespace PublicComponentCenter
{
    public static class AssetUtility
    {
        ...
        public static string GetUiSpriteAsset(string assetName, bool fromBytes = false)
        {
            return Utility.Text.Format("UiSprite/{0}/{1}", GameEntry.Localization.Language.ToString(), assetName);
        }

        public static string GetDictionaryAsset(string assetName, bool fromBytes)
        {
            return Utility.Text.Format("Localization/{0}/Dictionaries/{1}" +
                                       //".{2}" +
                                       "",
                GameEntry.Localization.Language.ToString(), assetName
                //, fromBytes ? "bytes" : "xml"
            );
        }
